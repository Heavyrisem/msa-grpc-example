 ...
 *
 * @generated from protobuf message test.Person
 */
...
/**
 * @generated MessageType for protobuf message test.Person
 */
export const Person = new Person$Type();
/**
 * @generated ServiceType for protobuf service test.TestService
 */
export const TestService = new ServiceType("test.TestService", [
    { name: "FindOne", options: {}, I: Person, O: Person }
]);
